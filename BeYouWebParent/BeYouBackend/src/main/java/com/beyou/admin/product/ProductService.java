...
public class ProductService {
    ...
    //method for checking of uniqueness of Brand based on name 
    public String checkUnique(Integer id, String name){
        //identify it is creating new category or not
    ...
    //function used to edit category to delete id from database
